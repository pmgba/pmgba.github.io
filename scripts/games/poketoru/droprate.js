...
+'				<label class="col-xs-2 control-label">掉落几率</label>'
;
	for (var j=0; j<=2; j++ ) {
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">所需经验</label>'
+'				<div class="col-xs-3">'
+'				<input class="form-control" type="textbox" name="shuffle-guage" onchange="calc()">'
+'				</div>'
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">每局花费</label>'
+'				<div class="col-xs-3">'
...
+'		<hr>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">平均掉落几率</label>'
+'				<div class="col-xs-3">'
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">需要局数</label>'
+'				<div class="col-xs-3">'
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">需要花费</label>'
+'				<div class="col-xs-3">'
...
+'		<hr>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">掉落0个几率</label>'
+'				<div class="col-xs-3">'
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">掉落1个几率</label>'
+'				<div class="col-xs-3">'
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">掉落2个几率</label>'
+'				<div class="col-xs-3">'
...
+'			</div>'
+'			<div class="form-group">'
+'				<label class="col-xs-2 control-label">掉落3个几率</label>'
+'				<div class="col-xs-3">'
